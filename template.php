 ...
 */
function avaliacao_digital_preprocess_maintenance_page(&$vars) {
 ...
 * HTML preprocessing
 */
function avaliacao_digital_preprocess_html(&$vars) {
 ...
 * Page preprocessing
 */
function avaliacao_digital_preprocess_page(&$vars) {
 ...
 */
function avaliacao_digital_preprocess_region(&$vars) {
  static $grid;
 ...
 * Block preprocessing
 */
function avaliacao_digital_preprocess_block(&$vars) {
 ...
 * Node preprocessing
 */
function avaliacao_digital_preprocess_node(&$vars) {
 ...
 */
function avaliacao_digital_preprocess_comment(&$vars) {
 ...
 */
function avaliacao_digital_preprocess_views_view(&$vars) {
 ...
 */
function avaliacao_digital_preprocess_search_result(&$vars) {
 ...
 */
function avaliacao_digital_region__header($vars) {
  return $vars['content'];
}
 ...
 */
function avaliacao_digital_file($vars) {
 ...
 */
function avaliacao_digital_theme() {
  return array(
    'grid_block' => array(
 ...
 */
function avaliacao_digital_block_list($region) {
  $drupal_list = array();
...
function avaliacao_digital_grid_block($vars) {
  $output = '';
  if ($vars['content']) {
    $id = $vars['id'];
 ...
 */
function avaliacao_digital_grid_info() {
  global $theme_key;
 ...
 */
function avaliacao_digital_theme_paths($theme) {
